...
export const queryParams = {
  ...
  // 数值参数
  MaxPersonalTamedDinos: { name: 'MaxPersonalTamedDinos', type: 'number', category: 'gameplay', description: '每个部落的恐龙驯服上限', default: 500, min: 1, max: 10000 },
  MaxTamedDinos: { name: 'MaxTamedDinos', type: 'number', category: 'gameplay', description: '服务器驯服恐龙总数上限', default: 4000, min: 1, max: 100000 },
  MinimumDinoReuploadInterval: { name: 'MinimumDinoReuploadInterval', type: 'number', category: 'gameplay', description: '恐龙重新上传冷却时间（秒）', default: 0, min: 0, max: 86400 },
  ...
  PersonalTamedDinosSaddleStructureCost: { name: 'PersonalTamedDinosSaddleStructureCost', type: 'number', category: 'gameplay', description: '平台鞍占用恐龙槽位数量', default: 19, min: 1, max: 100 },
  PreventOfflinePvPInterval: { name: 'PreventOfflinePvPInterval', type: 'number', category: 'gameplay', description: '离线PvP保护等待时间（秒）', default: 900, min: 0, max: 86400 },
  TheMaxStructuresInRange: { name: 'TheMaxStructuresInRange', type: 'number', category: 'gameplay', description: '服务器最大建筑数量', default: 10500, min: 1000, max: 50000 },

  // 字符串参数
  CustomLiveTuningUrl: { name: 'CustomLiveTuningUrl', type: 'string', category: 'performance', description: '自定义实时调优文件URL', default: '' },
  customdynamicconfigurl: { name: 'customdynamicconfigurl', type: 'string', category: 'performance', description: '自定义动态配置文件URL', default: '' },

  // 特殊参数
  bRawSockets: { name: 'bRawSockets', type: 'boolean', category: 'performance', description: '直接UDP连接（提升网络性能）', default: false },
  ...
  ExtinctionEventTimeInterval: { name: 'ExtinctionEventTimeInterval', type: 'number', category: 'gameplay', description: '灭绝事件时间间隔（秒）', default: 0, min: 0, max: 31536000 },
  ...
  // 数据传输参数
  PreventDownloadSurvivors: { name: 'PreventDownloadSurvivors', type: 'boolean', category: 'security', description: '禁止下载幸存者数据', default: false },
  PreventDownloadItems: { name: 'PreventDownloadItems', type: 'boolean', category: 'security', description: '禁止下载物品数据', default: false },
  PreventDownloadDinos: { name: 'PreventDownloadDinos', type: 'boolean', category: 'security', description: '禁止下载恐龙数据', default: false },
  PreventUploadSurvivors: { name: 'PreventUploadSurvivors', type: 'boolean', category: 'security', description: '禁止上传幸存者数据', default: false },
  PreventUploadItems: { name: 'PreventUploadItems', type: 'boolean', category: 'security', description: '禁止上传物品数据', default: false },
  PreventUploadDinos: { name: 'PreventUploadDinos', type: 'boolean', category: 'security', description: '禁止上传恐龙数据', default: false },

  // PvP参数
  PreventOfflinePvP: { name: 'PreventOfflinePvP', type: 'boolean', category: 'gameplay', description: '启用离线PvP保护', default: false }
}
...
export const commandLineArgs = {
  ...
  // 网络参数
  forcenetthreading: { name: 'forcenetthreading', type: 'boolean', category: 'performance', description: '强制启用网络多线程', default: false },
  nonetthreading: { name: 'nonetthreading', type: 'boolean', category: 'performance', description: '禁用网络多线程', default: false },
  ...
  // 图形参数
  allowansel: { name: 'allowansel', type: 'boolean', category: 'performance', description: '启用NVIDIA Ansel支持', default: false },
  d3d10: { name: 'd3d10', type: 'boolean', category: 'performance', description: '强制使用DX10（仅Windows）', default: false },
  nomansky: { name: 'nomansky', type: 'boolean', category: 'performance', description: '禁用天空细节（云层、星空）', default: false },
  sm4: { name: 'sm4', type: 'boolean', category: 'performance', description: '强制使用Shader Model 4（仅Windows）', default: false },
  noaafonts: { name: 'noaafonts', type: 'boolean', category: 'performance', description: '移除字体抗锯齿', default: false },
  ...
  EnableIdlePlayerKick: { name: 'EnableIdlePlayerKick', type: 'boolean', category: 'gameplay', description: '踢出空闲玩家', default: false },
  ...
  vday: { name: 'vday', type: 'boolean', category: 'gameplay', description: '情人节活动', default: false },
  webalarm: { name: 'webalarm', type: 'boolean', category: 'logging', description: '启用Web警报', default: false },

  // 高级参数
  ActiveEvent: { name: 'ActiveEvent', type: 'string', category: 'gameplay', description: '启用指定事件', default: '' },
  ...
  PublicIPForEpic: { name: 'PublicIPForEpic', type: 'string', category: 'performance', description: 'Epic客户端的公共IP地址', default: '' },
...
export const categories = {
  basic: { name: '基础设置', description: '服务器基础配置和常用参数' },
  gameplay: { name: '游戏机制', description: '游戏玩法、PvP、限制等核心游戏参数' },
  performance: { name: '性能优化', description: '服务器性能、网络、图形优化参数' },
  security: { name: '安全设置', description: '安全、反作弊、数据传输控制参数' },
  logging: { name: '日志记录', description: '日志记录、调试、监控相关参数' },
  mods: { name: '模组功能', description: '模组管理、自定义地图、平台相关参数' },
  maintenance: { name: '维护工具', description: '服务器维护、存档、清理工具参数' },
